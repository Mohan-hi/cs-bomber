...
W='\033[0m'
# The Credit For This Code Goes To MOHAN MV And All Other Contributors Listed At https://github.com/Mohan-hi/sms.call-bomber.git9
...
| $$\  $ | $$| $$  | $$| $$  | $$| $$  | $$| $$\  $$$      | $$\  $ | $$  \  $$$/  
| $$ \/  | $$|  $$$$$$/| $$  | $$| $$  | $$| $$ \  $$      | $$ \/  | $$   \  $/   
|__/     |__/ \______/ |__/  |__/|__/  |__/|__/  \__/      |__/     |__/    \_/
                                         """
...
def infinite(pn, dl, ch, max):
    ...
    while True:
        ...
        count_inf += 1
        # os.system('echo MOHAN MV >> count.xxx')
        time.sleep(float(dl))
        if (count_inf > maxlim):
            exit()
...
def start(target, counter, delay, ch, cc):
    ...
    while success < (int(bombs)):
        ...
        try:
            ...
            if cc == "91":
                print('Sorry All APIs Have Expired Please Update Mbomb')
                input('Press Enter To Exit...')
                exit()
            else:
                if success > 0:
                    print(
                        '\n\n\tI am Sorry To Say That Bombing Limit For Your Country Has Been Reached...')
                    print(
                        '\nI am Working Too Hard To Increase The International Limit...')
                    input(
                    ...
                    print(
                        '\t\tPlease Send A Mail To mohan32685629@gmail.com To Let Us Know...')
                    input('Press Enter To Exit...')
                    exit()
        ...
        print("              This Bomber Was Created By MOHAN MV !!                ")
        print("==================================================================")
        try:
...
def update():
    ...
    for fl in stuff_to_update:
        dat = urllib.request.urlopen(
            "https://raw.githubusercontent.com/Mohan-hi/sms.call-bomber/master/" + fl).read()
        file = open(fl, 'wb')
        file.write(dat)
        file.close()
    print('\n\t\tUpdated Successfull !!!!')
...
ver = urllib.request.urlopen(
    "https://raw.githubusercontent.com/Mohan-hi/sms.call-bomber/master/.version").read().decode('utf-8')
verl = ''
try:
...
try:
    noti = urllib.request.urlopen(
        "https://raw.githubusercontent.com/Mohan-hi/sms.call-bomber/master/.notify").read().decode('utf-8')
...
try:
    ...
    type = 0
if type == 1:
    nm = int(input("Enter Number of Calls To Send(Maximum 300): "))
    if nm > 6000:
        print("\t\tYou Have Entered " + str(nm) +
              ".\n\tNormalizing Value To 300")
        nm = 300
...
if cbomb:
    ...
    exit()
if nm == 0:
    nt = int(input("\tNumber Of Threads(10 to 100) : "))
    if nt <= 0 or nt >= 25:
        print('\tMbomb Shows Better Result in 10 to 25 Threads\n\t\tStill Continuing....')
